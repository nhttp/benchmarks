...
async function buildReadmeRuntime(runtime: any, name: string) {
...
await buildReadmeRuntime(deno, "Deno");
await buildReadmeRuntime(bun, "Bun");
await buildReadmeRuntime(node, "Node");
